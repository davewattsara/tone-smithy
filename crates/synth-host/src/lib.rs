...
//!
//! Wraps `cpal` (audio output) and `midir` (MIDI input). M3.2 opens the
//! first available MIDI input port at startup and routes note events
//! into the same engine bus the UI uses.
//!
