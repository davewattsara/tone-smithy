...
pub(crate) fn param_range_for_key(key: &str) -> Option<(ParamId, f32, f32)> {
    Some(match key {
        ...
        // Env2
        "env2_attack_secs" => (ParamId::Env2AttackSecs, 0.001, 10.0),
        "env2_decay_secs" => (ParamId::Env2DecaySecs, 0.001, 10.0),
        "env2_sustain_level" => (ParamId::Env2SustainLevel, 0.0, 1.0),
        "env2_release_secs" => (ParamId::Env2ReleaseSecs, 0.001, 10.0),
        // LFOs
        ...
        // Oscillator detune & pan
        "osc_1_detune_cents" => (ParamId::Osc1DetuneCents, -100.0, 100.0),
        "osc_2_detune_cents" => (ParamId::Osc2DetuneCents, -100.0, 100.0),
        "osc_3_detune_cents" => (ParamId::Osc3DetuneCents, -100.0, 100.0),
        "osc_1_pan" => (ParamId::Osc1Pan, -1.0, 1.0),
        "osc_2_pan" => (ParamId::Osc2Pan, -1.0, 1.0),
        "osc_3_pan" => (ParamId::Osc3Pan, -1.0, 1.0),
        // FX chorus
        "fx_chorus_mix" => (ParamId::FxChorusMix, 0.0, 1.0),
        "fx_chorus_rate_hz" => (ParamId::FxChorusRateHz, 0.1, 8.0),
        "fx_chorus_depth_ms" => (ParamId::FxChorusDepthMs, 0.0, 15.0),
        // FX delay
        "fx_delay_mix" => (ParamId::FxDelayMix, 0.0, 1.0),
        "fx_delay_time_secs" => (ParamId::FxDelayTimeSecs, 0.001, 2.0),
        "fx_delay_feedback" => (ParamId::FxDelayFeedback, 0.0, 0.95),
        // FX reverb
        "fx_reverb_mix" => (ParamId::FxReverbMix, 0.0, 1.0),
        "fx_reverb_size" => (ParamId::FxReverbSize, 0.1, 1.0),
        "fx_reverb_decay_secs" => (ParamId::FxReverbDecaySecs, 0.1, 30.0),
        "fx_reverb_damping" => (ParamId::FxReverbDamping, 0.0, 1.0),
        // FX drive
        "fx_drive_drive" => (ParamId::FxDriveDrive, 1.0, 20.0),
        // Arpeggiator
        "arp_bpm" => (ParamId::ArpBpm, 20.0, 300.0),
        "arp_gate" => (ParamId::ArpGate, 0.01, 1.0),
        "arp_swing" => (ParamId::ArpSwing, 0.5, 0.75),
        _ => return None,
    })
}
