...
impl ToneSmithyApp {
    ...
    fn sync_cc_to_ui(&mut self, key: &str, value: f32) {
        match key {
            ...
            "arp_enabled" => self.arp_enabled = value >= 0.5,
            "lfo1_reset_on_note_on" => self.lfo1_reset_on_note_on = value >= 0.5,
            "lfo1_sync_enabled" => self.lfo1_sync_enabled = value >= 0.5,
            "lfo2_reset_on_note_on" => self.lfo2_reset_on_note_on = value >= 0.5,
            "lfo2_sync_enabled" => self.lfo2_sync_enabled = value >= 0.5,
            "fx_eq_enabled" => self.fx_eq_enabled = value >= 0.5,
            "fx_drive_enabled" => self.fx_drive_enabled = value >= 0.5,
            "fx_chorus_enabled" => self.fx_chorus_enabled = value >= 0.5,
            "fx_delay_enabled" => self.fx_delay_enabled = value >= 0.5,
            "fx_delay_ping_pong" => self.fx_delay_ping_pong = value >= 0.5,
            "fx_reverb_enabled" => self.fx_reverb_enabled = value >= 0.5,
            "mod_slot_enabled_0" => self.mod_slot_enabled[0] = value >= 0.5,
            "mod_slot_enabled_1" => self.mod_slot_enabled[1] = value >= 0.5,
            "mod_slot_enabled_2" => self.mod_slot_enabled[2] = value >= 0.5,
            "mod_slot_enabled_3" => self.mod_slot_enabled[3] = value >= 0.5,
            "mod_slot_enabled_4" => self.mod_slot_enabled[4] = value >= 0.5,
            "mod_slot_enabled_5" => self.mod_slot_enabled[5] = value >= 0.5,
            "mod_slot_enabled_6" => self.mod_slot_enabled[6] = value >= 0.5,
            "mod_slot_enabled_7" => self.mod_slot_enabled[7] = value >= 0.5,
            // FM ratio integer (round to nearest int)
            "fm_op_ratio_integer_0_0" => self.fm_op_ratio_integer[0][0] = value.round().clamp(1.0, 15.0) as u8,
            "fm_op_ratio_integer_0_1" => self.fm_op_ratio_integer[0][1] = value.round().clamp(1.0, 15.0) as u8,
            "fm_op_ratio_integer_0_2" => self.fm_op_ratio_integer[0][2] = value.round().clamp(1.0, 15.0) as u8,
            "fm_op_ratio_integer_0_3" => self.fm_op_ratio_integer[0][3] = value.round().clamp(1.0, 15.0) as u8,
            "fm_op_ratio_integer_1_0" => self.fm_op_ratio_integer[1][0] = value.round().clamp(1.0, 15.0) as u8,
            "fm_op_ratio_integer_1_1" => self.fm_op_ratio_integer[1][1] = value.round().clamp(1.0, 15.0) as u8,
            "fm_op_ratio_integer_1_2" => self.fm_op_ratio_integer[1][2] = value.round().clamp(1.0, 15.0) as u8,
            "fm_op_ratio_integer_1_3" => self.fm_op_ratio_integer[1][3] = value.round().clamp(1.0, 15.0) as u8,
            _ => {}
        }
    }
}
...
pub(crate) fn key_to_param_id(key: &str) -> Option<ParamId> {
    Some(match key {
        ...
        // Booleans (CC ≥ 0.5 → on, < 0.5 → off)
        "arp_enabled" => ParamId::ArpEnabled,
        "lfo1_reset_on_note_on" => ParamId::Lfo1ResetOnNoteOn,
        "lfo1_sync_enabled" => ParamId::Lfo1SyncEnabled,
        "lfo2_reset_on_note_on" => ParamId::Lfo2ResetOnNoteOn,
        "lfo2_sync_enabled" => ParamId::Lfo2SyncEnabled,
        "fx_eq_enabled" => ParamId::FxEqEnabled,
        "fx_drive_enabled" => ParamId::FxDriveEnabled,
        "fx_chorus_enabled" => ParamId::FxChorusEnabled,
        "fx_delay_enabled" => ParamId::FxDelayEnabled,
        "fx_delay_ping_pong" => ParamId::FxDelayPingPong,
        "fx_reverb_enabled" => ParamId::FxReverbEnabled,
        "mod_slot_enabled_0" => ParamId::ModSlotEnabled(0),
        "mod_slot_enabled_1" => ParamId::ModSlotEnabled(1),
        "mod_slot_enabled_2" => ParamId::ModSlotEnabled(2),
        "mod_slot_enabled_3" => ParamId::ModSlotEnabled(3),
        "mod_slot_enabled_4" => ParamId::ModSlotEnabled(4),
        "mod_slot_enabled_5" => ParamId::ModSlotEnabled(5),
        "mod_slot_enabled_6" => ParamId::ModSlotEnabled(6),
        "mod_slot_enabled_7" => ParamId::ModSlotEnabled(7),
        // FM ratio integer (CC 0→1 maps to integer range 1→15)
        "fm_op_ratio_integer_0_0" => ParamId::FmOpRatioInteger(0x00),
        "fm_op_ratio_integer_0_1" => ParamId::FmOpRatioInteger(0x01),
        "fm_op_ratio_integer_0_2" => ParamId::FmOpRatioInteger(0x02),
        "fm_op_ratio_integer_0_3" => ParamId::FmOpRatioInteger(0x03),
        "fm_op_ratio_integer_1_0" => ParamId::FmOpRatioInteger(0x10),
        "fm_op_ratio_integer_1_1" => ParamId::FmOpRatioInteger(0x11),
        "fm_op_ratio_integer_1_2" => ParamId::FmOpRatioInteger(0x12),
        "fm_op_ratio_integer_1_3" => ParamId::FmOpRatioInteger(0x13),
        _ => return None,
    })
}
