...
- **Stage:** M12 (preset browser) complete — tag `m12` on `main`. Active: **M13 (Settings + MIDI Learn)**.
- **Licence:** `MIT OR Apache-2.0` dual.
- **Product name:** Tone Smithy.
- **Branches:** `main` (stable; last milestone merge is M12 at tag `m12`); `development` (active work — commit here).
